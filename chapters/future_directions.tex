...
% target specific industry: trading application, telephony softwares, etc.
  % The added safety could attract more customers?

% incorporate the broker into the framework itself, removing dependency on rabbitmq and would improve throughput?.
