...
\subsection{Latency of Request-Reply}
\label{subsec:request-reply-latency}
  The ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/10request-reply-latency}
    \caption[Throughput of request-reply]{Throughput of request-reply}
    \label{fig:result-request-reply-latency}
  \end{figure}
